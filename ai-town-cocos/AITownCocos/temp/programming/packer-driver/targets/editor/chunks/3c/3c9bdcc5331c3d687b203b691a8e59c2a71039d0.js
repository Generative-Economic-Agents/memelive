    ...
    execute: function () {
      ...
      _export("default", Index = (_dec = ccclass("Index"), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property({
        ...
        async start() {
          ...
          this.loginview.active = true; // director.preloadScene('mainView');

          let s = this; // Log.log(TAG, '<axios>', window["Axios"], window["NeteaseGame"], window["yyygame"])
          // Axios = window["Axios"];
        ...
        async getlogin() {
          ...
          (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
            ...
            error: Error()
          }), GlobalConfig) : GlobalConfig).instance.playername = this.edit_name.string;
        ...
        async goLogin() {
          ...
          if ((_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
            ...
            const debounceThings = (_crd && WebUtils === void 0 ? (_reportPossibleCrUseOfWebUtils({
              error: Error()
            }), WebUtils) : WebUtils).debounce(() => {
              let app = new (_crd && App === void 0 ? (_reportPossibleCrUseOfApp({
                error: Error()
              }), App) : App)();
              app.init();
...
//# sourceMappingURL=3c9bdcc5331c3d687b203b691a8e59c2a71039d0.js.map