    ...
    execute: function () {
      ...
      _export("BottomTapsComponent", BottomTapsComponent = (_dec = ccclass('BottomTapsComponent'), _dec2 = property({
        ...
        inputokClickHandler() {
          ...
          this.resetQipao();
          let tili = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
            error: Error()
        ...
        resetQipao() {
          ...
          let bg = this.node_qipao.getChildByName("Sprite"); //this.node_qipao.active = false;
...
//# sourceMappingURL=ae1920fd5fc03e1795c10bfc0c77086c4d80d982.js.map