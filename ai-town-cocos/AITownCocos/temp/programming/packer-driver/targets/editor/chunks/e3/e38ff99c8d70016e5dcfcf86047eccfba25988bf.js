    ...
    execute: function () {
      ...
      _export("TKComponents", TKComponents = (_dec = ccclass('TKComponents'), _dec2 = property({
        ...
        onEnable() {
          ...
          if (!s.isShowShape) {
            let spr_bg = s.node.getChildByName("spr_bg"); // spr_bg.color = "#0C0B0B9F";?
...
//# sourceMappingURL=e38ff99c8d70016e5dcfcf86047eccfba25988bf.js.map