      ...
      _export("default", TownModel = class TownModel extends (_crd && BaseModel === void 0 ? (_reportPossibleCrUseOfBaseModel({
        ...
        getServerCatsData(id) {
          ...
          if ((_this$_NPCsSeverData = this._NPCsSeverData) != null && _this$_NPCsSeverData.data) {
            let da = this._NPCsSeverData.data;
        ...
        getserItemCountById(id) {
          ...
          let da = (_this$playerItems = this.playerItems) == null ? void 0 : _this$playerItems.data;
        ...
        getserItemById(id) {
          ...
          let da = (_this$playerItems2 = this.playerItems) == null ? void 0 : _this$playerItems2.data;
        ...
        updateTasklist(da) {
          ...
          if (this != null && (_this$tasklist = this.tasklist) != null && _this$tasklist.data) {
            for (let index = 0; index < (this == null || (_this$tasklist2 = this.tasklist) == null ? void 0 : _this$tasklist2.data.length); index++) {
              var _this$tasklist2, _this$tasklist3;

              let element = this == null || (_this$tasklist3 = this.tasklist) == null ? void 0 : _this$tasklist3.data[index];
        ...
        getTaskserById(taskid) {
          ...
          if (this != null && (_this$tasklist4 = this.tasklist) != null && _this$tasklist4.data) {
            for (let index = 0; index < (this == null || (_this$tasklist5 = this.tasklist) == null ? void 0 : _this$tasklist5.data.length); index++) {
              var _this$tasklist5, _this$tasklist6;

              let element = this == null || (_this$tasklist6 = this.tasklist) == null ? void 0 : _this$tasklist6.data[index];
        ...
        checkcatReq() {
          let json = new (_crd && network === void 0 ? (_reportPossibleCrUseOfnetwork({
            error: Error()
        ...
        getShopList() {
          let shopListParameter = new (_crd && network === void 0 ? (_reportPossibleCrUseOfnetwork({
            error: Error()
        ...
        touchCat() {
          let touchWithCat = new (_crd && network === void 0 ? (_reportPossibleCrUseOfnetwork({
            error: Error()
        ...
        onMessage(da) {
          ...
          if (repData.command == 99998) {
            ...
            let load = director.loadScene("login", (error, scene) => {
          ...
          if (repData.command == 10002) {
            ...
            //任务状态改变
            let lasttask = _.clone(this.getTaskserById(da.data.data[0].taskId));
            ...
            let taskconf = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
              error: Error()
            ...
            let dropconfig = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
              error: Error()
            }), modelMgr) : modelMgr).configModel.getConfigById((_crd && StaticConfigModel === void 0 ? (_reportPossibleCrUseOfStaticConfigModel({
              error: Error()
