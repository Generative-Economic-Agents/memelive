          ...
          if (this._focusTarget && this._focusTarget.position) //计算加载tile区域的左上角point
            {
              ...
              let x = -this._focusTarget.position.x + (_crd && mGameConfig === void 0 ? (_reportPossibleCrUseOfmGameConfig({
                error: Error()
              }), mGameConfig) : mGameConfig).DeviceW / 2;
              let y = -this._focusTarget.position.y - (_crd && mGameConfig === void 0 ? (_reportPossibleCrUseOfmGameConfig({
                error: Error()
              }), mGameConfig) : mGameConfig).DeviceH / 2;

              let vec = this._focusTarget.parent.getPosition();
...
//# sourceMappingURL=3c3558a7522ed860d6ef73640bfdc65d708f2351.js.map