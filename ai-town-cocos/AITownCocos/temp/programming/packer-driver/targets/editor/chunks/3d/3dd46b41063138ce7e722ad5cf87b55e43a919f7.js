System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  function _reportPossibleCrUseOfLog(extras) {
    _reporterNs.report("Log", "../StaticUtils/LogUtils", _context.meta, extras);
  }
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "57624YE4DFO0I0E1hOJJ8PM", "WebUtils", undefined);
      ...
      _export("default", WebUtils = class WebUtils {
        ...
        static createSprite(width = 10, height = 10, name) {
          var _spr$getComponent;

          let spr = new Node();
          spr.layer = Layers.Enum.UI_2D; //Layer 设置要准确 ui_2d;

          spr.addComponent(Sprite);
          (_spr$getComponent = spr.getComponent(UITransform)) == null || _spr$getComponent.setAnchorPoint(new Vec2(0, 1));
...
//# sourceMappingURL=3dd46b41063138ce7e722ad5cf87b55e43a919f7.js.map