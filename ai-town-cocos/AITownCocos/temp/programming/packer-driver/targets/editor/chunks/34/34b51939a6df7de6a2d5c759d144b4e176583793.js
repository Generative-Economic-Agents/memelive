System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function showMsg2(msg, _par = null) {
    if (!_showMsg) _showMsg = new MessageManager();
  ...
  function showMsgPanel(msg, _par = null) {
    if (!_showMsg) _showMsg = new MessageManager();
    ...
    execute: function () {
      ...
      _export("default", MessageManager = class MessageManager {
        ...
        addmmessage() {
          ...
          try {
            let lab = s.recovMessage.getChildByName("spr_bg").getChildByName("label_desc");
...
//# sourceMappingURL=34b51939a6df7de6a2d5c759d144b4e176583793.js.map