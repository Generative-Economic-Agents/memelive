    ...
    execute: function () {
      ...
      _export("RenwuListItem", RenwuListItem = (_dec = ccclass('RenwuListItem'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Sprite), _dec(_class = (_class2 = class RenwuListItem extends Component {
        ...
        setData(data) {
          ...
          if (this._data) {
            let drop = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
              error: Error()
        ...
        freshStateHandler() {
          if (this._data) {
            let sertask = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
              error: Error()
...
//# sourceMappingURL=33ca12561e1f4513a1f8e03a74adacd813a48e80.js.map