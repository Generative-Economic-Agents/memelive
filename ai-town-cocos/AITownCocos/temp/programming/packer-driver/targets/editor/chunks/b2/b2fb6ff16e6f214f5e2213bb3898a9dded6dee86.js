    ...
    execute: function () {
      ...
      _export("UserinfoComponent", UserinfoComponent = (_dec = ccclass('UserinfoComponent'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(RichText), _dec13 = property(RichText), _dec14 = property(RichText), _dec15 = property(RichText), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Node), _dec21 = property(Node), _dec22 = property(Node), _dec23 = property(Node), _dec24 = property(Node), _dec(_class = (_class2 = class UserinfoComponent extends Component {
        ...
        chageCatinfoDataHandler() {
          let catid = (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
            error: Error()
          }), GlobalConfig) : GlobalConfig).instance.getCurCatId();
          let catdata = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
            error: Error()
          }), modelMgr) : modelMgr).mainModel.getServerCatsData(catid);
          const guideInfo = (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
            error: Error()
            ...
            if (curccnum == "") {
              ...
              if (Number(curccnum) != cvend) {
                if (Number(curccnum) < cvend) {
                  ...
                  (_this$spriteAtlasAnim = this.spriteAtlasAnimation) == null ? void 0 : _this$spriteAtlasAnim.play();
        ...
        */
        ...
        chageCatByTouchHandler(data = null) {
          let catid = (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
            error: Error()
          }), GlobalConfig) : GlobalConfig).instance.getCurCatId();
          let catdata = data ? data.data.data : (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
            error: Error()
          }), modelMgr) : modelMgr).mainModel.getServerCatsData(catid);
          const guideInfo = (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
            error: Error()
          ...
          let touchText = (_crd && TouchCatTips === void 0 ? (_reportPossibleCrUseOfTouchCatTips({
            error: Error()
            ...
            if (curccnum == "") {
              ...
              if (Number(curccnum) != cvend) {
                ...
                if (Number(curccnum) < cvend) {
                  ...
                  (_this$spriteAtlasAnim2 = this.spriteAtlasAnimation) == null ? void 0 : _this$spriteAtlasAnim2.play();
                  this.heartChangeTxt.string = `<color=#FF0000>+${cvend - Number(curccnum)}</color>`;
                  this.heartChangeTxtReverse.string = `<color=#FF0000>+${cvend - Number(curccnum)}</color>`;
                  this.heartRed.active = true;
                  this.heartBlack.active = false;
        ...
        changeCatsHandler() {
          ...
          if (catdata) {
            ...
            let mbti = (_instance$curCatData = (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
              error: Error()
        ...
        updatePlayersData() {
          ...
          if (this.Label_ap.string == "") {
            ...
            let apend = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
              error: Error()
          ...
          if (this.Label_cc.string == "") {
            ...
            if (Number(this.Label_cc.string) != apend2) {
              if (Number(this.Label_cc.string) < apend2) {
                ...
                (_this$jinbispriteAtla = this.jinbispriteAtlasAnimation) == null ? void 0 : _this$jinbispriteAtla.play();
              }
          ...
          if (this.Label_cv.string == "") {
            ...
            let mbti = (_instance$curCatData2 = (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
              error: Error()
...
//# sourceMappingURL=b2fb6ff16e6f214f5e2213bb3898a9dded6dee86.js.map