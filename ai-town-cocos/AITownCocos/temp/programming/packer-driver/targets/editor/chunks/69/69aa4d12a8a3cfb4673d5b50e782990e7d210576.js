      ...
      _export("NetworkCtrl", NetworkCtrl = (_dec = ccclass('NetworkCtrl'), _dec(_class = class NetworkCtrl {
        ...
        constructor() {
          ...
          if (currentURL.indexOf("localhost") != -1 || currentURL.indexOf("192.168") != -1) {
            ...
            //this._url = "wss://www.infinitytest.cc:8989"
            this._url = "wss://cat.infinityg.ai/api/ws"; //this._url = "wss://cat.infinitytest.cc/api/ws"
        ...
        prepareWebSocket() {
          ...
          let websocketLabel = "";
          let respLabel = "";
          let url = this._url; // if (assetManager.cacheManager) {
          ...
          let _wsiSend = this._wsiSendBinary; // this._wsiSendBinary = new WebSocket('wss://echo.websocket.events', [], url);
        ...
        onmessage(evt) {
          ...
          let binaryStr = 'response bin msg: '; // let str = '0x';
...
//# sourceMappingURL=69aa4d12a8a3cfb4673d5b50e782990e7d210576.js.map