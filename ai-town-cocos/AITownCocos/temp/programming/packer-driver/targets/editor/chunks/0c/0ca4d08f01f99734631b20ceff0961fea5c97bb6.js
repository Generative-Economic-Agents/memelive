System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, Sprite, WebUtils, modelMgr, observer, socket, GlobalConfig, showMsg2, network, EventType, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, PetsItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "6404fcsJe1CQI6Toq7Lcewe", "PetsItem", undefined);
      ...
      _export("PetsItem", PetsItem = (_dec = ccclass('PetsItem'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Sprite), _dec5 = property(Sprite), _dec(_class = (_class2 = class PetsItem extends Component {
        ...
        */
        ...
        updateData(da) {
          ...
          if (this._da) {
            let CurCatId = (_crd && GlobalConfig === void 0 ? (_reportPossibleCrUseOfGlobalConfig({
              error: Error()
            ...
            if (!this._servda) {// console.warn("没有图片:", this._da);
              ...
              let mbti = (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
                error: Error()
...
//# sourceMappingURL=0ca4d08f01f99734631b20ceff0961fea5c97bb6.js.map