      ...
      _export("ListViewCtrl4", ListViewCtrl4 = (_dec = ccclass("ListViewCtrl4"), _dec2 = menu('UI/ListViewCtrl4'), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(ScrollView), _dec(_class = _dec2(_class = (_class2 = class ListViewCtrl4 extends Component {
        ...
        initialize() {
          ...
          for (let i = 0; i < this._itemdata.length; i++) {
            ...
            const indexlabelComp = item.getComponent(_crd && ListItemComponent === void 0 ? (_reportPossibleCrUseOfListItemComponent({
              error: Error()
          ...
          if (this._itemdata.length >= 100) {
            let item = instantiate(this.cellnode);
        ...
        addItem() {
          // 创建新元素
          let newItem = instantiate(this.itemTemplate); // 将新元素添加到内容节点
...
//# sourceMappingURL=bd9af7a4bf35aad0d67ba88213a1b2e074bf3307.js.map