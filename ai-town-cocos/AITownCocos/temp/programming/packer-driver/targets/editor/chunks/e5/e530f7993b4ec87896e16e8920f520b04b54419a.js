System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _crd, GuideIndex, ShopPicMap, ToySpineMap, CatSpineMap, ToysInfo, TouchCatTips, TouchUnhappyCatTips, ActionType, SpineName, namePool, occupationPool, termsTxt;

  function getTouchCatTip(tipNumber, catName = null) {
    const baseTip = TouchCatTips[tipNumber];
    return tipNumber === 2 ? `${catName} feel very comfortable` : TouchCatTips[tipNumber];
  }

  _export("getTouchCatTip", getTouchCatTip);
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ae8b535l8xOq432mmoZ9fGy", "StaticTextConfig", undefined);

      _export("GuideIndex", GuideIndex = {
        START_GUIDE_STATE1: {
          start: 1,
          end: 1
        },
      ...
      _export("CatSpineMap", CatSpineMap = {
        100012: {
      ...
      _export("TouchUnhappyCatTips", TouchUnhappyCatTips = {
...
//# sourceMappingURL=e530f7993b4ec87896e16e8920f520b04b54419a.js.map