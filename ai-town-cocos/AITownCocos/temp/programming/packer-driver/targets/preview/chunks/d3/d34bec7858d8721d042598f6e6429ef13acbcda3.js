System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, SingleMessage, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5b806HvekBPRKNnwsgGXH/S", "SingleMessage", undefined);

      __checkObsolete__(['Label', 'Sprite', 'resources', 'SpriteFrame', 'UITransform', 'view', 'tween']);

      _export("default", SingleMessage = class SingleMessage {// constructor(bg: Sprite, word: Sprite) {
        //     let self = this;
        //     self._bgCon = bg;
...
//# sourceMappingURL=d34bec7858d8721d042598f6e6429ef13acbcda3.js.map