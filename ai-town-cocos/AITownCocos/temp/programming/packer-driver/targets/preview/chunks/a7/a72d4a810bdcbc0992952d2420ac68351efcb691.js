System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "3805c9r+KBOaJCJ99V36jZr", "JishiGoumaiZZTK", undefined);
      ...
      _export("JishiGoumaiZZTK", JishiGoumaiZZTK = (_dec = ccclass('JishiGoumaiZZTK'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Node), _dec10 = property(Label), _dec(_class = (_class2 = (_class3 = class JishiGoumaiZZTK extends Component {
        constructor() {
          super(...arguments);
          ...
          _initializerDefineProperty(this, "itempic", _descriptor5, this);

          _initializerDefineProperty(this, "Label_name", _descriptor6, this);

          _initializerDefineProperty(this, "Label_jieshao", _descriptor7, this);

          _initializerDefineProperty(this, "spr_xiangou", _descriptor8, this);

          _initializerDefineProperty(this, "chiyou", _descriptor9, this);
        ...
        start() {
          ...
          if (JishiGoumaiZZTK.oprType == "goumai") {
            ...
            this.sinbox.getComponent(_crd && SpinBoxComponent === void 0 ? (_reportPossibleCrUseOfSpinBoxComponent({
              error: Error()
            }), SpinBoxComponent) : SpinBoxComponent).max = JishiGoumaiZZTK.DATA.quota;
          } else {
            ...
            this.sinbox.getComponent(_crd && SpinBoxComponent === void 0 ? (_reportPossibleCrUseOfSpinBoxComponent({
              error: Error()
            }), SpinBoxComponent) : SpinBoxComponent).max = JishiGoumaiZZTK.DATA.amount;
          }
          ...
          (_crd && WebUtils === void 0 ? (_reportPossibleCrUseOfWebUtils({
            error: Error()
          }), WebUtils) : WebUtils).getRemoteImg(JishiGoumaiZZTK.DATA.icon + "?imageView&thumbnail=162x191", this.itempic);
        }
        ...
        */
        ...
        closeself() {
          (_crd && uiMgr === void 0 ? (_reportPossibleCrUseOfuiMgr({
            error: Error()
          }), uiMgr) : uiMgr).removeParent("prefabs/jishi/pre_jishiGmZZ");
        }

      }, _class3.oprType = "", _class3.DATA = void 0, _class3), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "sinbox", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
      ...
      }), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "itempic", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "Label_name", [_dec7], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor7 = _applyDecoratedDescriptor(_class2.prototype, "Label_jieshao", [_dec8], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "spr_xiangou", [_dec9], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
      ...
      }), _descriptor9 = _applyDecoratedDescriptor(_class2.prototype, "chiyou", [_dec10], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
//# sourceMappingURL=a72d4a810bdcbc0992952d2420ac68351efcb691.js.map