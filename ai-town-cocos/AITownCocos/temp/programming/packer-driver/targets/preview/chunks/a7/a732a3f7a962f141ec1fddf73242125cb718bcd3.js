  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", TiaozhuanMananger = class TiaozhuanMananger {
         ...
         */
        static getTentrance() {
          var storage = (_crd && BoswerUtils === void 0 ? (_reportPossibleCrUseOfBoswerUtils({
            error: Error()
          ...
          var urlparam = (_crd && BoswerUtils === void 0 ? (_reportPossibleCrUseOfBoswerUtils({
            error: Error()
...
//# sourceMappingURL=a732a3f7a962f141ec1fddf73242125cb718bcd3.js.map