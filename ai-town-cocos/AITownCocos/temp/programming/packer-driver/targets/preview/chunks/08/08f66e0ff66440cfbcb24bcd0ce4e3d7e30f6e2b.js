System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "lodash-es"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, modelMgr, ListViewCtrl2H, toNumber, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _crd, ccclass, property, TAG, workSelectCatComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "7c213ke3NhKAalhtOJiMYTb", "workSelectCatComponent", undefined);
      ...
      _export("workSelectCatComponent", workSelectCatComponent = (_dec = ccclass('workSelectCatComponent'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Number), _dec(_class = (_class2 = class workSelectCatComponent extends Component {
        ...
        */
        ...
        hideUseBtn() {
          console.log(TAG, 'click hideUseBtn');
...
//# sourceMappingURL=08f66e0ff66440cfbcb24bcd0ce4e3d7e30f6e2b.js.map