System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Button, modelMgr, observer, EventType, AudioManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, TabGroup;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "4317bmSm7tDjIUANcb9ZRVG", "TabGroup", undefined);
      ...
      _export("TabGroup", TabGroup = (_dec = ccclass('TabGroup'), _dec2 = property({
        ...
        start() {
          //记录打开当前页index,即使被销毁后
          this.on_tab_button_click(null, (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
            error: Error()
          }), modelMgr) : modelMgr).mainModel.currentTapIndex[this.tabtype]);
        ...
        enable_tab(index) {
          if (this.tabbtns[index]) {
            ...
            (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
              error: Error()
            }), modelMgr) : modelMgr).mainModel.currentTapIndex[this.tabtype] = index;
        ...
        refresh_tab_content(e, index) {
          ...
          (_crd && observer === void 0 ? (_reportPossibleCrUseOfobserver({
            ...
            error: Error()
          }), EventType) : EventType).UPDATE_SHOP_INDEX, index + 1);
        }
        /**
         * 外部改变tabgroup
         * @param ind 
        ...
        resetAllTabs() {
          ...
          (_crd && modelMgr === void 0 ? (_reportPossibleCrUseOfmodelMgr({
            error: Error()
          }), modelMgr) : modelMgr).mainModel.currentTapIndex[this.tabtype] = -1;
        }
...
//# sourceMappingURL=cde8281e41d0edf2b6f392417f2590aae974a557.js.map