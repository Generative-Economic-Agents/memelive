System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, Camera, RenderTexture, director, gfx, SpriteFrame, ImageAsset, Sprite, Texture2D, Vec3, Canvas, WASManager, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, postCardSize, windowSize, upLoadPostcard, JietuComponent;
      ...
      _export("JietuComponent", JietuComponent = (_dec = ccclass('JietuComponent'), _dec2 = property(Camera), _dec3 = property(Canvas), _dec4 = property(Sprite), _dec(_class = (_class2 = class JietuComponent extends Component {
        ...
        capture(size, path) {
          ...
          this.scheduleOnce(() => {
            ...
            var temp = this.base64Head.split("data:image/jpeg;base64,")[1];
            (_crd && WASManager === void 0 ? (_reportPossibleCrUseOfWASManager({
              error: Error()
            }), WASManager) : WASManager).setConfig();
            var arrayBuffer = base64ToUint8Array(temp);
            (_crd && WASManager === void 0 ? (_reportPossibleCrUseOfWASManager({
              error: Error()
...
//# sourceMappingURL=88dc478b9cf9b250fac5b03a1b73ad02dae38aa9.js.map