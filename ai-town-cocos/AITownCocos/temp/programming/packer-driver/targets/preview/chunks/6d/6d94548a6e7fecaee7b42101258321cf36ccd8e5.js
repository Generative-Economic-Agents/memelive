System.register(["__unresolved_0", "__unresolved_1", "crypto", "fs", "path"], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    execute: function () {
      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        var iniLoader = AWS.util.iniLoader; // Tracking refresh attempt to ensure refresh is not attempted more than once every 30 seconds.
            ...
            self.service.createToken(params, function (err, data) {
              if (err || !data) {
                ...
                try {
                  ...
                  } catch (error) {// Swallow error if unable to write token to file.
                  }
                } catch (error) {
                  refreshUnsuccessful(currentTime, tokenExpireTime, callback);
                }
...
//# sourceMappingURL=6d94548a6e7fecaee7b42101258321cf36ccd8e5.js.map