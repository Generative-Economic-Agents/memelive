  ...
  return {
    ...
    execute: function () {
      ...
      _export("EventType", EventType = {
        ...
        //更换刷新头像框
        UPDATE_ROLE_PLAY_INDEX: "UPDATE_ROLE_PLAY_INDEX",
        //更换人物部分的icon数组
        //显示对话记录按钮
        ...
        SOCKET_GETALL_NPCS: "SOCKET_GETALL_NPCS",
        //查询所有NPC
        SOCKET_ONLINE_NPCS: "SOCKET_ONLINE_NPCS",
        //上线NPC
        SOCKET_OFFLINE_NPCS: "SOCKET_OFFLINE_NPCS",
        //下线NPC
        SOCKET_NPC_MOVE: "SOCKET_NPC_MOVE",
        //下线NPC
        SOCKET_NPC_ACTION: "SOCKET_NPC_ACTION",
        //NPC action
        OBJECT_STATE_CHANGE: "OBJECT_STATE_CHANGE",
        //NPC action
        SOCKET_ITEM_STATE_CHANGE: "SOCKET_ITEM_STATE_CHANGE",
        //NPC action
...
//# sourceMappingURL=75613785e2bcb60bc47754a5d362eff9b16fe3e6.js.map