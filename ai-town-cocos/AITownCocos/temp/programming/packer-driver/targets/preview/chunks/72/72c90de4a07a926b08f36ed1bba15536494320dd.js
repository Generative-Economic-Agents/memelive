System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, ModuleID, JishiModule, TownModule, ModuleManager, _crd;
  ...
  function _reportPossibleCrUseOfTownModule(extras) {
    _reporterNs.report("TownModule", "../town/TownModule", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      TownModule = _unresolved_4.default;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("default", ModuleManager = class ModuleManager {
        ...
        initModule() {
          ...
          moduDic[(_crd && ModuleID === void 0 ? (_reportPossibleCrUseOfModuleID({
            error: Error()
          }), ModuleID) : ModuleID).TOWN] = new (_crd && TownModule === void 0 ? (_reportPossibleCrUseOfTownModule({
            error: Error()
          }), TownModule) : TownModule)((_crd && ModuleID === void 0 ? (_reportPossibleCrUseOfModuleID({
            error: Error()
          }), ModuleID) : ModuleID).TOWN); //集市界面
        }
        /**
         *
         * @param moduleId
        ...
        openModu(moduleId, modOpenData) {
          if (modOpenData === void 0) {
            modOpenData = null;
          }

          var self = this;
          if (moduleId) moduleId = moduleId;
          var modu = this._moduDic[moduleId];
          if (!modu) return;
...
//# sourceMappingURL=72c90de4a07a926b08f36ed1bba15536494320dd.js.map