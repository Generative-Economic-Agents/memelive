System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, BoneResManager, _crd;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "369606BOUdIEZC5NisWWhdk", "BoneResManager.ts", undefined);

      _export("default", BoneResManager = class BoneResManager {
        constructor() {
        ...
        static get ins() {
          ...
          if (self._ins == null) {
            ...
            var agent = navigator.userAgent; // if (agent.indexOf('iPhone') == -1&&agent.indexOf('AWM-A0') == -1) {
...
//# sourceMappingURL=a7c766125e8fda0bedd82ed035afdd03ef3236b6.js.map