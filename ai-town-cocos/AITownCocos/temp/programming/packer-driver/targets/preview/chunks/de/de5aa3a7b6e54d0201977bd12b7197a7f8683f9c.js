System.register(["__unresolved_0", "cc", "lodash-es", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _, EventType, BaseModel, showMsg2, mduManger, modelMgr, observer, socket, GlobalConfig, RedManager, network, StaticConfigModel, ModuleID, director, GuideIndex, Log, MainModel, _crd, TAG;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      GuideIndex = _unresolved_11.GuideIndex;
    }, function (_unresolved_12) {
      Log = _unresolved_12.default;
    }],
    execute: function () {
      _crd = true;

      _cclegacy._RF.push({}, "3e3c8EKYzNDiIT20il3ze4k", "MainModel", undefined);
        ...
        chgServerCatsData(cat) {
          ...
          if ((_this$_catsSeverData2 = this._catsSeverData) != null && _this$_catsSeverData2.data) {
            ...
            if (curCats) {
              ...
              (_this$_catsSeverData3 = this._catsSeverData) == null || _this$_catsSeverData3.data.push(cat);
            }
          }
        }
...
//# sourceMappingURL=de5aa3a7b6e54d0201977bd12b7197a7f8683f9c.js.map