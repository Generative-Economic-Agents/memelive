        ...
        update(deltaTime) {
          if (this.enabled) {
            ...
            if (this.currentFrame >= this.totalFrames) {
              ...
              (_this$onCompleteCallb = this.onCompleteCallback) == null ? void 0 : _this$onCompleteCallb.call(this); // 调用回调函数
...
//# sourceMappingURL=bfba8e2d74b22fd9905393a1e7e7b7e6d8426d04.js.map